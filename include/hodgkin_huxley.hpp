...
void initializeArrays(const double *statesOneInstanceParameter, [[maybe_unused]] const int *algebraicsForTransferIndicesParameter, const int *statesForTransferIndicesParameter,
